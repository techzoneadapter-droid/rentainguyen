            ...
            {createTab === 'bm' && (
              <>
                ...
                <div className={styles.formCard}>
                  ...
                  <div className={styles.permissionStrip}><span className={currentToken?.status === 'active' ? styles.statusLive : styles.statusWarn}>{currentToken ? STATUS_TEXT[currentToken.status] : 'Chưa chọn token'}</span><span>{currentPermissions.includes('business_management') ? '✓ business_management' : '• business_management chưa thấy'}</span><span>{currentPermissions.includes('pages_show_list') ? '✓ pages_show_list' : '• pages_show_list chưa thấy'}</span></div>
